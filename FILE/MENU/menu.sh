...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/onexd77/sange/main/FILE/PLUGINS/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/onexd77/sange/main/FILE/PLUGINS/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/onexd77/sange/main/FILE/PLUGINS/versi)
...
echo -e "$COLOR1 ${NC}                ${WH}• ONE SANGE 2023 •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
